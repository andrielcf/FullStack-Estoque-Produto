...
SECRET_KEY = 'django-insecure-khik&%^u6qz^f==m42z8*fi!(w+5w3q+9z#zbt!wwfq^wm3w4$'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'estoque_db',  # Substitua pelo nome do seu banco de dados
        'USER': 'name',    # Substitua pelo seu nome de usuário do MySQL
